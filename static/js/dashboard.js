...
const hideOverlay = () => {
    ...
    // deleteFormDialog.classList.add('hide');
}
...
const createSuggestion = (suggestion) => {
    ...
    suggestionElement = template.content.querySelector('.suggestion-card').cloneNode(true);
    ...
    .then((data) => {
        ...
        try {
            data.forEach(suggestion => {
                ...
                console.log(elem);
                dashboardMainContent.appendChild(elem);
            })
        } catch (error) {
            console.log(error);
        }
...
const createEvent = (event) => {
    ...
    eventElement = template.content.querySelector('.event-card').cloneNode(true);
